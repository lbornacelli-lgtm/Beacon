...
TIMESTAMP_FILE   = "/home/ufuser/Downloads/Beacon-main/weather_station/logs/last_daily_report.txt"
...
def _build_email_body(new_wavs: list[dict], since: datetime) -> str:
    ...
    lines += [
        ...
        f"Log: /home/ufuser/Downloads/Beacon-main/weather_station/logs/alert_service.log",
    ]
    return "\n".join(lines)
